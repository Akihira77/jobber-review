...
describe("Review controller - Get method", () => {
    describe("reviewsByGigId() method", () => {
        it("Return 200 empty reviews", async () => {
            const { body, statusCode } = await supertest(serverApp).get(
                `${reviewApi}/gig/65ea7e48d784cc0840f1906`
            );
        ...
        it("Return 200 and reviews", async () => {
            const { body, statusCode } = await supertest(serverApp).get(
                `${reviewApi}/gig/65ea7e48d784cc0840f19069`
            );
    ...
    describe("reviewsBySellerId() method", () => {
        it("Return 200 empty reviews", async () => {
            const { body, statusCode } = await supertest(serverApp).get(
                `${reviewApi}/seller/65ea7e48d784cc0840f1906`
            );
        ...
        it("Return 200 and reviews", async () => {
            const { body, statusCode } = await supertest(serverApp).get(
                `${reviewApi}/seller/65e9cc7c1d2eacf8631ba73b`
            );
